...
namespace MT.Common.SendMessage
{
    public static class SendMsg
    {
        ...
        private static readonly string ACCOUNT = "1001@501140490001";

        // 接口密钥, 请换成你的帐号对应的接口密钥
        private static readonly string AUTHKEY = "E24FD27C0CFF985A5BB8C72AB5BF6CBF";

        // 通道组编号, 请换成你的帐号可以使用的通道组编号
        private static readonly uint CGID = 184;
        ...
        static void Main(string[] args)
        {
            ...
            {
                // 提交成功
                Console.WriteLine("你的帐号余额: " + ret.fRemain.ToString("0.000") + "元");
            }
            else
            {
                Console.WriteLine("获取帐号余额失败, 错误码是: " + ret.nResult.ToString());
                Console.ReadLine();
                return;
            }

            // 请修改发送的手机号码和内容, 发送单个号码
            int nRet = sendOnce("18297974783", "(C#)中国短信网示例测试");
