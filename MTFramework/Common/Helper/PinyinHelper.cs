...
namespace MT.Common
{
    public static class PinyinHelper
    {
        ...
        ////        public static string ToPinYin(this string txt)
        ////        {
        ////            txt = txt.Trim();
        ...
        //        /////   <param   name="txt"> 需要转换的汉字 </param>   
        //        /////   <returns> 返回汉字对应的拼音 </returns>   
        //        //public static string ToPinYinFirst(this string txt)
        //        //{
        //        //    txt = txt.Trim();
        //        //    byte[] arr = new byte[2];   //每个汉字为2字节   
        //        //    StringBuilder result = new StringBuilder();//使用StringBuilder优化字符串连接  
        ...
        //        //                    if (CodeCollections.ContainsKey(i))
        //        //                    {
        //        //                        result.Append("" + CodeCollections[i].ToCharArray()[0] + "");
        //        //                        break;
        //        //                    }
        //        //                }
        //        //            }
        //        //            else
        //        //            {
        //        //                result.Append("" + CodeCollections[charCode].ToCharArray()[0] + "");
        //        //            }
        //        //        }
        //        //    }
        //        //    return result.ToString().ToUpper();
        ...
        //        public static string NoSpz(this string str)
        //        {
        //            str = str.Replace("座", "Z");
        //            str = str.Replace("做", "Z");
        //            str = str.Replace("坐", "Z");
        ...
        //        /// <param name="hzString">汉字字符串</param>
        //        /// <returns>转换后的拼音(全拼)字符串</returns>
        //        public static string ToPinYinFirst(this string hzString)
        //        {
        //            // 匹配中文字符
        //            Regex regex = new Regex("^[\u4e00-\u9fa5]$");
        //            byte[] array = new byte[2];
        ...
        public static string sub(string str,int num =0)
        {
            ...
            string substr = str1.Substring(str1.Length-num);
            return substr;
        }
    }
}