...
namespace System.Web.Mvc
{
    ...
    public sealed class DropDownListAttribute : Attribute, ITemplateField
    {
        ...
        public DropDownListAttribute(string viewDataKey)
            : this(viewDataKey, "Value", "Text", null)
        {
            
        }

        public DropDownListAttribute(string viewDataKey, string optionLabel)
            : this(viewDataKey, "Value", "Text", optionLabel)
        {
